...
ALL_ATTRIBUTES = RAW_ATTRIBUTES + [CLASS_ATTRIBUTE, REWARD_ATTRIBUTE]
...
class DataWriter:
    ...
    def __init__(self, base_filename):
        """
        Args:
            base_filename: e.g. "data_agent_raw" or "data_keyboard_raw"
    ...
    def buffer_instance(self, game):
        ...
        """
        # Build feature vector: raw + action
        raw = [
            game.x_position,
            game.y_position,
            game.x_velocity,
...
def main():
    ...
    if USE_AGENT:
        data_filename = "data_agent_raw"
        print("\nRunning in AGENT mode (move_tutorial_1)")
    else:
        data_filename = "data_keyboard_raw"
